...
function findClosestOption(e: Event, type: string) {
...
function updateRadioSelection(selectedLanguage: string, type: string) {
    if (type === 'language') {
...
function convertToBinary(rawAudioData: string) {
